...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky stashable class="bg-zinc-50 dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-700">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.item icon="map" href="{{ route('trips.index') }}" :current="request()->routeIs('trips.index') || request()->routeIs('trips.show')">
                My Trips
            </flux:navlist.item>
        ...
        <flux:navlist variant="outline">
            <flux:navlist.item icon="arrow-right-start-on-rectangle" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                Logout
            </flux:navlist.item>
        </flux:navlist>
